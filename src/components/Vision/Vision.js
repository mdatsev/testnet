import './Vision.scss';
import animation from '../../assets/videos/Character 1.mp4';
        ...
        <section className="vision" id="vision">
            ...
            <div className="vision__content">
                ...
                <div className="vision__content__desc">
                    ...
                    Buff Doges are a collection of 5555 unique generative characters precisely designed, but they are not alone! Every planet will have its own collection, where they face each other in the Galaxy War game, where our community will be able to access the metaverse and determine their winners while earning money playing their favorite game.
                    </p>
                </div>
            </div>
        </section>
