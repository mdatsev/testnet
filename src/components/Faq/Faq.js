    ...
    const data = {
        rows: [
            ...
            },
            {
                ...
                content: "Holders will automatically joinBuffs private club where all the fun begins. And can free min 2 of each Buff category  As a member, you will be part of all activities and future ideas. As a holder, you will have the ability to make a change on our journey by being part of taking decisions for every step we take together as a community."
            },
            {
