    ...
    const data = {
        rows: [
            ...
            },
            {
                ...
                content: "Buff Doges will cost for 0.08 ETH (Public Sale) & 0.06 ETH (Presale) + Gass Fee."
            },
            {
            ...
            },
            {
                ...
                content: "Holders will automatically join Buffs private club where all the fun begins. And can free mint 2 of each Buff category as a holder, you will be part of all activities and future ideas. As a holder, you will have the ability to make a change on our journey by being part of taking decisions for every step we take together as a community."
            },
            {
