            ...
            <div className="roadmap__content container">
                <div className="roadmap__content__item">
                    ...
                    <div className="roadmap__content__item__sidePic right">
                        <video autoPlay loop muted width="260" height="260" alt="pic" src={side1}></video>
                    </div>
                </div>
                <div className="roadmap__content__item">
                    <span>Phase 3</span>
                    ...
                    <div className="roadmap__content__item__sidePic top phase3">
                        <video autoPlay loop muted width="260" height="260" alt="pic" src={side2}></video>
                    </div>
                ...
                <div className="roadmap__content__item">
                    ...
                    <div className="roadmap__content__item__sidePic right">
                        <video autoPlay loop muted width="260" height="260" alt="pic" src={side3}></video>
                    </div>
                </div>
                <div className="roadmap__content__item">
                    <span>phase 5</span>
                    ...
                    <div className="roadmap__content__item__sidePic">
                        <video autoPlay loop muted width="260" height="260" alt="pic" src={side4}></video>
                    </div>
                </div>
                <div className="roadmap__content__item">
                    <span>phase 6</span>
                    ...
                    <div className="roadmap__content__item__sidePic right">
                        <video autoPlay loop muted width="260" height="260" alt="pic" src={side5}></video>
                    </div>
                </div>
            </div>
        </section>
